...
from trajectory import LinearTrajectory, NegativeTimeException


class LinearTrajectoryTest(unittest.TestCase):

    def setUp(self):
        super(LinearTrajectoryTest, self).setUp()
    ...
    def test_given_trajectory_when_time_is_negative_an_exception_is_raised(self):
        self.assertRaises(NegativeTimeException, self.trajectory.get_position_at, -1)
