...
from trajectory.lissajous_trajectory import LissajousTrajectory


class LissajousTrajectoryTest(unittest.TestCase):

    def setUp(self):
        self.trajectory = LissajousTrajectory(1, 1, 3, 2, 4)
        self.expected_position = Point()

    def test_when_getting_trajectory_name_then_lissajous_is_returned(self):
        self.assertEqual('lissajous', self.trajectory.get_name())

    def test_given_lissajous_trajectory_when_getting_position_after_0s_then_position_is_returned(self):
    ...
    def test_given_lissajous_trajectory_when_getting_position_after_1s_then_position_is_returned(self):
    ...
    def test_given_lissajous_trajectory_when_getting_position_after_2s_then_position_is_returned(self):
        self.expected_position.x = -1
        self.expected_position.y = 0
        self.assertPositionAlmostEqual(self.expected_position, self.trajectory.get_position_at(2), 0.01)

    def test_given_lissajous_trajectory_when_getting_position_after_3s_then_position_is_returned(self):
        self.expected_position.x = 0
        self.expected_position.y = 0
        self.assertPositionAlmostEqual(self.expected_position, self.trajectory.get_position_at(3), 0.01)

    def test_given_lissajous_trajectory_when_getting_position_after_4s_then_position_is_returned(self):
        self.expected_position.x = 1
        self.expected_position.y = 0
